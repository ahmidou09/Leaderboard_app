...
This project is a Leaderboard app application created using webpack
...
The Leaderboard Website is an application that displays scores submitted by different players and allows users to submit their scores. All data is managed through an external Leaderboard API service. The main goal is to build a fully functional leaderboard website using medium-fidelity wireframes and integrating it with the API service.
...
- **Connect to an external API and send/receive data**
- **Implement actions for "Refresh" and "Submit" buttons**
...
```sh
  ...
  git clone https://github.com/ahmidou09/Leaderboard_app.git
```
